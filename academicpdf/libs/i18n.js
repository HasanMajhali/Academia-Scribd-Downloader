...
const I18n = {
    en: {
        ...
        overlay: {
            ...
            hq_native_badge: "RECOMMENDED",
            hq_native_tooltip: "Attempts to download original high-resolution images from the server. Best quality and sharpness.",
            hq_fit_btn: "COMPATIBLE SCAN",
            hq_fit_sub: "Smooth scrolling mode",
            hq_fit_badge: "SAFE",
            hq_fit_tooltip: "Traditional screen-capture scan. Use this if 'Native HQ' generates layout issues.",
    ...
    tr: {
        ...
        overlay: {
            ...
            hq_native_badge: "ÖNERİLEN",
            hq_native_tooltip: "Sunucudaki orijinal yüksek çözünürlüklü görselleri indirir. En net ve en kaliteli sonuç budur.",
            hq_fit_btn: "UYUMLU TARAMA",
            hq_fit_sub: "Sorunsuz kaydırma modu",
            hq_fit_badge: "GÜVENLİ",
            hq_fit_tooltip: "Klasik ekran görüntüsü taraması. Eğer 'Native HQ' yerleşim hatası verirse bunu kullanın.",
